...
| Live post-edit | Language-pair terminology profile | Swift | Built in | Exact source/draft phrase corrections plus bounded same-pair term consistency; no second model pass. |

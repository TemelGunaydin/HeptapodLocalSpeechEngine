...
| --- | --- | --- | ---: | --- |
| VAD | Silero VAD | Adapter required | ~8 MB | Low-cost silence gate |
| ASR | Qwen3 ASR 0.6B 4-bit | Adapter pending | ~760 MB | Good default |
| ASR | Qwen3 ASR 1.7B 8-bit | Adapter pending | ~3.6 GB | Higher accuracy |
...
| MT | MADLAD-400 3B | Adapter pending | ~2.8 GB | Practical first local translator |
...
| TTS | Kokoro 82M | Adapter required | ~130 MB | Smallest useful TTS |
